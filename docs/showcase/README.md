...
| [screenshots/](./screenshots/) | Desktop PNG captures (1440×900); Discover, Python citation, Docker gap, Track and Analytics were recaptured from fresh synthetic data after PR #113 fixes. Other screenshots retain their earlier capture revision. |
